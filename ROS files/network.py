...
from furnace.base_model import resnet18
from furnace.seg_opr.seg_oprs import ConvBnRelu, AttentionRefinement, FeatureFusion
from model.pipe_detection.pix2pix_networks import define_G, define_D, GANLoss


def get():
    return BiSeNet(config.num_classes, None, None)

class PipeSeg(nn.Module):
    def __init__(self, out_planes, is_training,
                 criterion, ohem_criterion, pretrained_model=None,
                 norm_layer=nn.BatchNorm2d):
        super(PipeSeg, self).__init__()
