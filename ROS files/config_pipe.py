...
C.dataset_path = "/media/data/dimpsar/datasets/New_Pipeline_Dataset2/"
C.img_root_folder = C.dataset_path + 'RGB/'
C.gt_root_folder = C.dataset_path + 'annotations/'
...
C.target_size = 640
C.image_height = 720  # 768
C.image_width = 1280  # 768 * 2
C.gt_down_sampling = 8
# C.gt_down_sampling = 16  # *2 for MobileNetV2
C.num_train_imgs = 764
C.num_eval_imgs = 138
...
C.pretrained_model = "/media/FastData/dimpsar/PycharmProjects/PipeSeg/model_zoo/pytorch_model/resnet18_v1.pth"
