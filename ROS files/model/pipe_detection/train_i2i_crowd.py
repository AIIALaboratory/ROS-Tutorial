...
from dataloader import get_train_loader_Crowd
from network import BiSeNet_crowd
...
with Engine(custom_parser=parser) as engine:
    ...
    # data loader
    train_loader, train_sampler = get_train_loader_Crowd(engine, Pipeline)
    ...
    model = BiSeNet_crowd(config.num_classes, is_training=True,
                    criterion=criterion,
    ...
    for epoch in range(engine.state.epoch, config.nepochs):
        ...
        for idx in pbar:
            ...
            if (idx+1) % 100 == 0:
                ...
                save_org_img = model.data_resized[0, :, :, :] * std_tensor_RGB + mean_tensor_RGB # change
